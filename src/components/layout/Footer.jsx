        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6 items-center">
            <div className="w-full flex items-center gap-4">
              ...
              <div className="w-full flex flex-wrap gap-3 text-nowrap md:flex-nowrap">
                {[
                  ...
                  <a
                    key={index}
                    className="w-full text-[#c9b396] hover:text-white text-sm"
                  >
                    {item}
                  </a>
                ))}
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-end gap-4">
              ...
              <Link
                to="/contact"
                className="bg-[#be9b6c] text-gray-900 px-4 py-2 rounded-full text-sm font-medium transition w-full sm:w-auto text-center"
              >

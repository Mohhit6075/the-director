...
export default function Home() {
  ...
  return (
    <div>
      ...
      <div className="min-h-screen bg-[url('/images/bg.jpg')] bg-cover bg-center bg-no-repeat ">
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
              {categories.map((category) => (
                <Link to={`/category/${category.id}`} key={category.id} className="w-full">
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div className="max-w-md w-full flex flex-col gap-6">
              ...
              <p className="text-[#e8e8e8] text-[17px] font-light">
                Step into a new world where creativity meets innovation and
                your vision becomes reality. Experience the extraordinary with
          ...
          <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="flex flex-col gap-4">
              ...
              <p className="text-gray-950">
                Our clothing is designed to make you feel confident and
                stylish. From casual wear to formal attire, we have everything
                you need to elevate your wardrobe.
              </p>
              <p className="text-gray-950">
                Start with the customer – find out what they need and give it to them.
              </p>
              <a
                href=""
        ...
        <section className="pb-80 pt-20 relative text-white bg-[#140f09] backdrop-opacity-20">
          <div className="z-10 max-w-7xl mx-auto px-6 text-center">
            ...
            <p className="text-md text-gray-300 mb-12 max-w-2xl mx-auto">
              Put yourself at the center of an extraordinary fashion universe
          ...
          <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              ...
              <p className="text-gray-900 text-md mb-6">
                ...
                receive the best quality clothing available at competitive
                prices. All our products come with a satisfaction guarantee.{" "}
              </p>
          ...
          <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-gray-900 text-md mb-4">
                ...
                you, providing unparalleled comfort without compromising on
                style. Experience clothing that feels like a second skin.
              </p>
              <a className=" w-fit text-md text-[#765a34] flex items-end gap-2 ">
                Continue Reading{" "}
